...
当前 `0.47.0`：新增按海岸日轮换的每日委托，把低潮观察、拾取与交易、台球击球与落袋、雨中漫步和黄昏相机收藏串成可持续目标。任务进度独立存档，可在图鉴新增的“委托”页领取潮贝，小铺店主也能直接引导进入。见 [每日海岸委托与跨系统事件学习记录](docs/COASTAL_COMMISSIONS_047.md)。
