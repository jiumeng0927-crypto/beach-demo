...
当前 `0.48.0`：新增三日轮换的海滨订单、十位 NPC 独立关系和社区声望。拾取物既可普通寄售，也可向指定 NPC 定向交付获得更高报酬；每日首次见面与完成订单提升关系，声望等级提高后续订单奖励。交易页、NPC 对话和本地存档保持同步。见 [海滨订单、NPC 关系与社区声望学习记录](docs/COASTAL_COMMUNITY_048.md)。
